    ...
    <div className="bg-brand-dark py-16 sm:py-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 animate-fade-in-up">
          <h2 className="text-blue-700 font-semibold text-brand-primary uppercase tracking-wide">Who We Are</h2>
        ...
        <div className="mt-20 bg-blue-600 text-white rounded-xl shadow-lg p-8 md:p-12 animate-fade-in-up">
          ...
          <button className="inline-flex items-center justify-center px-6 py-2 border border-white text-base font-medium rounded-full text-white hover:bg-white hover:text-brand-primary transition-colors duration-300">
